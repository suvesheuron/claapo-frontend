...
export default function VendorRegistration() {
  ...
  const phoneWrapperClass = (name: keyof FieldErrors) => {
    if (fieldErrors[name]) return 'border-[#F40F02]/40 focus-within:border-[#F40F02] focus-within:ring-[#F40F02]/15';
    if (touched[name] && !fieldErrors[name]) return 'border-emerald-400 focus-within:border-emerald-500 focus-within:ring-emerald-500/20';
