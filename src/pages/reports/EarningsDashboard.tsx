...
export default function EarningsDashboard() {
  ...
  const stats = [
    ...
    { label: 'Average Invoice', value: formatPaise(Math.round(avgInvoice)), icon: FaFileInvoice, accent: 'bg-[#EEF2FF] text-[#3B5BDB]' },
  ];
                ...
                <>
                  ...
                  <div className="rounded-2xl bg-white border border-neutral-200 overflow-hidden">
                    <div className="px-5 py-4 border-b border-neutral-100">
                      <h2 className="text-sm font-bold text-neutral-900">Recent Invoices</h2>
                    </div>
                    ...
                    {recentInvoices.length === 0 ? (
                      <div className="p-12 text-center">
                        ...
                        <p className="text-sm font-semibold text-neutral-700 mb-1">No invoices yet</p>
