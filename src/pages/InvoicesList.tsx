            ...
            <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 py-5">
              ...
              {!loading && allInvoices.length > 0 && (
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <FaMagnifyingGlass className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-400 w-4 h-4" />
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-neutral-200 bg-white text-sm placeholder-neutral-400 focus:outline-none focus:border-[#3678F1]"
                    />
                  </div>
                </div>
              )}
              ...
              {loading ? (
                ...
                <div className="rounded-2xl bg-white border border-neutral-200 p-12 text-center">
                  ...
                  {projectSearch.trim() ? (
                    <>
                      <p className="text-base font-semibold text-neutral-700 mb-1">No invoices match your search</p>
                      <p className="text-sm text-neutral-400 mb-4">Try a different project name or clear the search.</p>
                      <button type="button" onClick={() => setProjectSearch('')} className="text-sm text-[#3678F1] font-semibold hover:underline">Clear search</button>
                    </>
                  ) : (
                    <>
