...
import { FaBuilding, FaShieldHalved, FaCertificate, FaHandshake, FaCircleCheck, FaLock, FaTriangleExclamation, FaEye, FaEyeSlash } from 'react-icons/fa6';
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      minLength={8}
                      disabled={loading}
                      className="rounded-xl w-full px-3 py-2.5 pr-11 border border-neutral-300 bg-[#F3F4F6] text-neutral-900 placeholder-neutral-400 focus:outline-none focus:border-[#3678F1] focus:bg-white text-sm transition-all disabled:opacity-50"
                    />
