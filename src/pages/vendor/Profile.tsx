...
import {
  ...
  FaBuilding, FaPhone, FaEnvelope, FaLocationDot, FaIdCard, FaStar,
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div className="lg:col-span-1 space-y-4">
                  <div className="rounded-2xl bg-white border border-neutral-200 p-5 text-center">
                    <div className="flex justify-center mb-3">
                      <div className="relative">
                        <Avatar name="Equipment Rentals Co." size="lg" />
                        <button
                          type="button"
                    ...
                    <h2 className="text-base font-bold text-neutral-900 mb-0.5">Equipment Rentals Co.</h2>
                    <p className="text-xs text-neutral-500 mb-1">Camera & Lighting Equipment Vendor</p>
                    <div className="flex items-center justify-center gap-1 mb-2">
                      {[1, 2, 3, 4, 5].map((i) => (
                        <FaStar key={i} className={`text-[11px] ${i <= 4 ? 'text-[#F4C430]' : 'text-neutral-200'}`} />
                      ))}
                      <span className="text-[11px] text-neutral-500 ml-1">4.8 (132 reviews)</span>
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-neutral-100 space-y-2 text-left">
                      {[
                        ...
                        { icon: FaIdCard,   label: 'GST: 27ABCDE1234F1Z5' },
                      ].map(({ icon: Icon, label }) => (
                  ...
                  <div className="rounded-2xl bg-white border border-neutral-200 p-4">
                    ...
                    {[
                      { label: 'Total Rentals',    value: '86' },
                      { label: 'Equipment Items',  value: '24' },
                  ...
                  {/* Specialties */}
                  <div className="rounded-2xl bg-white border border-neutral-200 p-4">
                    <h3 className="text-xs font-bold text-neutral-700 mb-3 uppercase tracking-wide">Specialties</h3>
                    <div className="flex flex-wrap gap-1.5">
                      {specialties.map((s) => (
                        <span key={s} className="text-[11px] px-2 py-0.5 rounded-full bg-[#EEF4FF] text-[#3678F1] font-medium border border-[#BFDBFE]">
                          {s}
                        </span>
                      ))}
                    </div>
                ...
                <div className="lg:col-span-2 space-y-4">
                  ...
                  <div className="rounded-2xl bg-white border border-neutral-200 p-5">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            type="text"
                            defaultValue="Equipment Rentals Co."
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            type="email"
                            defaultValue="rentals@equipmentco.in"
                            className="w-full pl-9 pr-3 py-2.5 border border-neutral-300 rounded-xl text-sm focus:outline-none focus:border-[#3678F1] focus:ring-1 focus:ring-[#3678F1]/20 transition-all"
                          />
                        </div>
                      </div>
                      <div>
                        <label className="block text-xs font-medium text-neutral-600 mb-1">Address / Pickup Location</label>
                        <div className="relative">
                          <FaLocationDot className="absolute left-3 top-3 text-neutral-400 w-3.5 h-3.5" />
                          <textarea
                            defaultValue="Warehouse 12, MIDC Andheri East, Mumbai — 400093"
                            rows={2}
                      ...
                      <div>
                        ...
                        <textarea
                          defaultValue="Mumbai-based equipment rental company with 8 years of experience serving top production houses. Specializing in camera, lighting, and audio equipment."
                          rows={3}
                          className="w-full px-3 py-2.5 border border-neutral-300 rounded-xl text-sm focus:outline-none focus:border-[#3678F1] focus:ring-1 focus:ring-[#3678F1]/20 transition-all resize-none"
                        />
                      </div>
                    </div>
                    <div className="mt-4 flex justify-end">
                      <button
                        type="button"
                        onClick={() => alert('Vendor profile saved!')}
