              ...
              {panel.status === 'available' && blockForm && (
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <button type="button" onClick={handleConfirmBlock} disabled={saving} className="flex-1 rounded-xl py-2.5 bg-[#3678F1] text-white text-sm font-semibold hover:bg-[#2563d4] transition-colors disabled:opacity-50">
